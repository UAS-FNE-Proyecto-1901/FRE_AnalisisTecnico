...
```{r ControlesVentasFRE, echo=FALSE, warning=FALSE, fig.cap='Controles en las ventas directas a pacientes.', fig.width=8, fig.height=6, fig.topcaption=TRUE, out.width="85%",fig.align='center',fig.pos='t'}
