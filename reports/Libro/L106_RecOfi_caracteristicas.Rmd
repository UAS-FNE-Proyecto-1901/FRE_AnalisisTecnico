...
```{r MedidasSeguridadRec, echo=FALSE, warning=FALSE, fig.cap='Medidas de seguridad en los recetarios reportadas por los FRE.', fig.width=7, fig.height=5, fig.topcaption=TRUE, out.width="90%",fig.align='center', fig.pos="t!"}
...
g1 <- readRDS(file.path(fig_path, "046b_ComparativoCostosRecetarios1.rds")) + labs(title = NULL)

g1[[1]] <- g1[[1]] + xlab('No de personas vinculadas al FRE')
g1
```
