...
box1 <- tag1$div(
  bloqueContactos('Daniel Sebastián Parra González', 'Contratista - Profesional universitario', 
                  './credit_figures/daniel.jpeg'),
  class = "credPrincipalSup"
)
# 
box2 <- crearListaLatex(c('Daniel Sebastián Parra González (Contratista - Profesional universitario)'))
