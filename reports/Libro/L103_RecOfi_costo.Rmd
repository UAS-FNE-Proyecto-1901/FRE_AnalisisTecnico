...
```{r DependParcial1, echo=FALSE, warning=FALSE, fig.cap='Gráficos de dependencia parcial - Modelo de Costos', fig.width=9, fig.height=5, fig.topcaption=TRUE, out.width="90%"}
