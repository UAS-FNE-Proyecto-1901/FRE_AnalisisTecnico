...
\fancyhead[LE,RO]{\includegraphics[width=0.5\paperwidth]{www/logos_MinSalud_FNE.png}} 
\fancyhead[LO,RE]{}
...
{\centering \includegraphics[width=0.9\linewidth]{InformeFinal_files/figure-latex/ExKM1-1} 

}

\caption{Clasificación de los FRE en grupos de acuerdo a análisis por clúster ExKMC}\label{fig:ExKM1}
\end{figure}
