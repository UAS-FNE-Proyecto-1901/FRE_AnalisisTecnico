...
Los amplios márgenes de ganancia y sus diferencias entre los distintos FRE, se podrían relacionar con: (a) cantidad de medidas de seguridad del recetario, (b) facilidad de acceso del departamento, (c) número de prescripciones, (d) tipo de licitación o (e) cantidad de empresas oferentes en los procesos de contratación de recetarios oficiales.
...
\textbackslash caption\{Proporción (\%) de FRE que diligencian campos en bases de datos de venta de recetarios\}\label{fig:BD-diligBDRecet}
