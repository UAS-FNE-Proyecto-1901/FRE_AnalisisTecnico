...
\begin{figure}
\includegraphics[width=0.9\linewidth]{InformeFinal_files/figure-latex/FrecComprasFNRb-1} \caption{N.° de pedidos de medicamentos por año al FNE}\label{fig:FrecComprasFNRb}
\end{figure}
