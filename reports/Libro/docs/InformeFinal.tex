...
\hypertarget{anuxe1lisis-a-nivel-nacional}{%
\chapter{Análisis a nivel nacional}\label{anuxe1lisis-a-nivel-nacional}}

\maxdeadcycles=1000

\hypertarget{estructura-del-fre}{%
\section{Estructura del FRE}\label{estructura-del-fre}}

\hypertarget{fecha-de-constituciuxf3n-de-fre}{%
\subsection{Fecha de constitución de FRE}\label{fecha-de-constituciuxf3n-de-fre}}
...
\subsection{Estructura organizacional}\label{estructura-organizacional}}
...
\subsection{Instituciones inscritas en el FRE}\label{instituciones-inscritas-en-el-fre}}
...
\subsection{Caracterización de las fuentes de ingresos de los FRE}\label{caracterizaciuxf3n-de-las-fuentes-de-ingresos-de-los-fre}}
...
\section{Recetarios oficiales}\label{recetarios-oficiales}}
...
\begin{figure}
\includegraphics[width=0.85\linewidth]{InformeFinal_files/figure-latex/FrecExistenciaRecetarios-1} \caption{Frecuencia de revisión de existencia de recetarios}\label{fig:FrecExistenciaRecetarios}
\end{figure}
...
\section{Ruta tecnológica}\label{ruta-tecnoluxf3gica}}
...
\hypertarget{adquisiciuxf3n-de-mme-y-manejo-de-inventarios}{%
\section{Adquisición de MME y manejo de inventarios}\label{adquisiciuxf3n-de-mme-y-manejo-de-inventarios}}

\hypertarget{adquisiciuxf3n-de-mme-por-parte-del-fre}{%
\subsection{Adquisición de MME por parte del FRE}\label{adquisiciuxf3n-de-mme-por-parte-del-fre}}
...
\subsection{Vencimiento de medicamentos}\label{vencimiento-de-medicamentos}}
...
\subsection{Almacenamiento}\label{almacenamiento}}
...
\begin{figure}
\includegraphics[width=0.85\linewidth]{InformeFinal_files/figure-latex/MetodosSeguimientoControlAmbiental-1} \caption{Tecnologías de control y seguimiento de condiciones ambientales}\label{fig:MetodosSeguimientoControlAmbiental}
\end{figure}

\begin{figure}
\includegraphics[width=0.85\linewidth]{InformeFinal_files/figure-latex/FrecSeguimientoCalibracion-1} \caption{Frecuencia de calibración y mantenimiento de equipos de seguimiento ambiental}\label{fig:FrecSeguimientoCalibracion}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.85\linewidth]{InformeFinal_files/figure-latex/FrecControlExistencias-1} \caption{Frecuencia del control de existencias de medicamentos MME}\label{fig:FrecControlExistencias}
\end{figure}

\begin{figure}
\includegraphics[width=0.9\linewidth]{InformeFinal_files/figure-latex/FrecControlExistenciasMapa-1} \caption{Frecuencia del control de existencias de medicamentos MME (mapa)}\label{fig:FrecControlExistenciasMapa}
\end{figure}
...
\section{Reporte de informes}\label{reporte-de-informes}}
