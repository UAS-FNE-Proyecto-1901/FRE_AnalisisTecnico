...
\fancyhead[LE,RO]{} 
\fancyhead[LO,RE]{\includegraphics[width=0.5\paperwidth]{www/logos_MinSalud_FNE.png}}
...
\begin{tikzpicture}[overlay, remember picture] %-Cambio de fondo de página
	...
	\coordinate [right=11cm, below=5.5cm] (highpoint) at (current page.north west);
	\coordinate [right=11cm, below=16.5cm] (midpoint) at (current page.north west);
	\coordinate [right=11cm, below=18.0cm] (lowpoint) at (current page.north west);
	\coordinate [right=7.5cm, below=24.5cm] (finalLogo) at (current page.north west);
	...
	\node at (current page.north west)
	{
		\begin{tikzpicture}[overlay, remember picture]
			...
			\draw[anchor=north] (highpoint) node [fill=bgBlue, fill opacity=0.01, text opacity=1.0, inner sep=1cm,  text=txBlue]{\Huge\centering\bfseries\sffamily\parbox[c][][t]{16cm}
...
{\centering \includegraphics[width=0.9\linewidth]{InformeFinal_files/figure-latex/PCA1-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{InformeFinal_files/figure-latex/PCA1-2-1} 
