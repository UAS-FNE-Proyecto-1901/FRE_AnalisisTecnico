...
```{r existenciasRecetarios, echo=FALSE, fig.cap='Existencia de recetarios en el FRE. (A) N.° de existencias de recetarios en el FRE y (B) Cobertura de existencias de recetarios en el FRE.', fig.width=12, fig.height=5, fig.topcaption=TRUE, out.width="100%", fig.align='center'}
