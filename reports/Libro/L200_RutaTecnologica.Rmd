...
```{r MediosComunicacion, echo=FALSE, warning=FALSE, fig.cap='Canales de comunicación FRE con clientes.', fig.width=7, fig.asp=0.85, fig.topcaption=TRUE, out.width="90%", fig.align='center'}
...
```{r ConexionInternet, echo=FALSE, warning=FALSE, fig.cap='Velocidad de conexión de internet.', fig.width=7, fig.height=5, fig.topcaption=TRUE, out.width="85%", fig.align='center'}
...
```{r GarantiaInformacion, echo=FALSE, warning=FALSE, fig.cap='Medidas para garantizar la seguridad de la información.', fig.width=6, fig.height=4, fig.topcaption=TRUE, out.width="85%", fig.align='center'}
...
```{r InformInscritos, echo=FALSE, warning=FALSE, fig.cap='Proporción de FRE que cuenta con: (A) bases de datos con información de inscritos, o (B) bases de datos con información de pacientes a los que se les dispensa MME.', fig.width=10, fig.height=4, fig.topcaption=TRUE, out.width="100%",fig.align='center'}
