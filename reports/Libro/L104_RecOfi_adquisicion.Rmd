...
```{r procesoContractual, echo=FALSE, warning=FALSE, fig.cap="Proceso de contratación/licitación de los recetarios oficiales.", fig.width=9, fig.height=5, fig.topcaption=TRUE, out.width="80%",fig.align='center'}
