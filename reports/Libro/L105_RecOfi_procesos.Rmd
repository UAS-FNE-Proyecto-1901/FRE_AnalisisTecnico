...
```{r BD-diligBDRecet, echo=FALSE, warning=FALSE, fig.cap='Proporción de FRE que diligencian campos en BD de venta de recetarios', fig.width=7, fig.asp=0.5, fig.topcaption=TRUE, out.width="85%", fig.align='center', fig.pos="t!"}
