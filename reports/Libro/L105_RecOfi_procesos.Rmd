...
```{r ReciboRecetariosInstituciones, echo=FALSE, warning=FALSE, fig.cap='Recepción de recetarios. Panel A. Porcentaje de entes territoriales que reciben recetarios oficiales recibidos prescritos/diligenciados. Panel B. Tiempo de recepción de recetarios oficiales desde IPS.', fig.width=10, fig.height=5, fig.topcaption=TRUE, out.width="100%",fig.align='center'}
...
```{r BD-diligBDRecet, echo=FALSE, warning=FALSE, fig.cap='Proporción de FRE que diligencian campos en BD de venta de recetarios', fig.width=7, fig.height=4, fig.topcaption=TRUE, out.width="85%",fig.align='center'}
...
```{r SeguimientoUsoRecetarios, echo=FALSE, warning=FALSE, fig.cap='Actividades realizadas por el FRE para el seguimiento del uso de recetarios', fig.width=8, fig.height=5, fig.topcaption=TRUE, out.width="85%",fig.align='center'}
...
```{r TiempoArchivoRecetariosOficiales, echo=FALSE, warning=FALSE, fig.cap='Tiempo de archivo de los recetarios oficiales en los FRE', fig.width=7, fig.height=5, fig.topcaption=TRUE, out.width="85%",fig.align='center'}
