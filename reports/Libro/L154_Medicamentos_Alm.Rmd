...
```{r PropOcupacionAlmacen, echo=FALSE, warning=FALSE, fig.cap='Ocupación promedio del MME frente a otros medicamentos o ítems almacenados en el FRE.', fig.width=6, fig.asp=0.7, fig.topcaption=TRUE,fig.align='center', out.width="85%", fig.pos="!b"}
