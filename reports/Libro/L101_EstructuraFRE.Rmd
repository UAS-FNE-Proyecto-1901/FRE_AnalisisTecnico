...
```{r perfilProfesionalEncargado, echo=FALSE, fig.cap='Perfil de profesional de encargados de los FRE.', fig.width=13, fig.height=5, fig.topcaption=TRUE, out.width="100%", fig.align='center', fig.pos='b'}
...
```{r PCA1-2, echo=FALSE, warning=FALSE, fig.cap='Clasificación de los FRE en grupos de acuerdo a análisis por clúster', fig.width=8.5, fig.asp=0.65, fig.topcaption=TRUE, out.width="90%", message=FALSE,fig.align='center',fig.pos='t'}
