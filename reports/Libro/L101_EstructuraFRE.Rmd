...
wrap_plots(g1, g2) + plot_annotation()
```
...
```{r institucionesInscritasVARdemo, echo=FALSE, fig.cap='Relación entre N° de instituciones inscritas y tamaño poblacional del departamento y número de camas de acuerdo a REP', fig.width=10, fig.height=4, out.width="100%", fig.topcaption=TRUE, message=FALSE, warning=FALSE}
