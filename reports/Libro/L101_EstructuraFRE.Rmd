...
```{r institucionesInscritasVARdemo, echo=FALSE, fig.cap='Relación de N.° de instituciones inscritas en el FRE con: (A) tamaño de la población en el departamento o (B) N.° de camas de acuerdo a REPS.', fig.width=10, fig.height=4, out.width="100%", fig.topcaption=TRUE, message=FALSE, warning=FALSE,fig.align='center',fig.pos='t!'}
