...
```{r perfilProfesional2, echo=FALSE, fig.cap='Perfil de profesional de personal asociado a los FRE.', fig.width=8, fig.asp=0.5, fig.topcaption=TRUE, out.width="90%", fig.align='center',fig.pos='t!'}
