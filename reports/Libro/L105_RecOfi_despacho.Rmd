...
```{r MedidasSeguridad-Almacenamiento, echo=FALSE, warning=FALSE, fig.width=7, fig.height=5, fig.topcaption=TRUE, out.width="85%"}
#| fig.cap: "Proporción de FRE con medidas de seguridad implementada en almacenamiento de recetarios"
